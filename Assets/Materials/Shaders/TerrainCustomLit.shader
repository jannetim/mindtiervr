...
Shader "Shader Forge/customFlat" {
    ...
    SubShader {
        ...
        Pass {
            ...
            #pragma only_renderers d3d9 glcore gles n3ds wiiu 
            #pragma target 2.0
